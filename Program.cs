...
namespace DiscordBot
{
    class Program : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task BotMain()
        {
            ...
            await client.LoginAsync(TokenType.Bot, "OTY5ODI5NTA5MzU0Mzc3MjQ2.YmzGHQ.PTTzBaTfbRdCmCgfBjhXuvxYaGc"); //봇의 토큰을 사용해 서버에 로그인
            ...
            client.ButtonExecuted += ButtonClick;
        ...
        public async Task ButtonClick(SocketMessageComponent component)
        {
            await component.DeferAsync();
            if (component.Data.CustomId == "Test")
            {
                await Context.Channel.SendMessageAsync("Clicked!");
            }
        }
    }
}