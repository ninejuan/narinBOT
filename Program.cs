...
namespace DiscordBot
{
    class Program
    {
        ...
        public async Task BotMain()
        {
            ...
            await client.LoginAsync(TokenType.Bot, "OTY4Nzg0MTExNTg0MDM0ODQ2.Ymj4gw.XjtXBZvtwVOcj_hPk1O2euZkgPE"); //봇의 토큰을 사용해 서버에 로그인
        ...
        private async Task OnClientMessage(SocketMessage arg)
        {
            ...
            if (!(message.HasStringPrefix("나린아 ", ref pos) ||
...
namespace DiscordBot
{
    class Program
    {
        ...
        public async Task BotMain()
        {
            ...
            await client.LoginAsync(TokenType.Bot, "OTY4Nzg0MTExNTg0MDM0ODQ2.Ymj4gw.TwHRwjTs84zhHaEslJyszySgrAQ"); //봇의 토큰을 사용해 서버에 로그인
            await client.StartAsync();                         //봇이 이벤트를 수신하기 시작
        ...
        private async Task OnClientMessage(SocketMessage arg)
        {
            ...
            //메시지 앞에 접두사가 달려있지 않고, 자신이 호출된게 아니거나 다른 봇이 호출했다면 취소
            if (!(message.HasStringPrefix("나린아 ", ref pos) ||
             message.HasMentionPrefix(client.CurrentUser, ref pos)) ||
              message.Author.IsBot)
                return;
...
namespace DiscordBot
{
    class Program
    {
        ...
        public async Task RunBotAsync()
        {
            ...
            string token = "OTY4Nzg0MTExNTg0MDM0ODQ2.Ymj4gw.XjtXBZvtwVOcj_hPk1O2euZkgPE";
        ...
        private async Task HandleCommandAsync(SocketMessage arg)
        {
            ...
            int argPos = 0;
            if (message.HasStringPrefix("나린아 ", ref argPos))
            {
